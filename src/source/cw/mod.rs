...
pub use source::{
    ...
    CW_DEFAULT_GAP_SECS, CW_DEFAULT_JITTER_PCT, CW_DEFAULT_REPEAT, CW_DEFAULT_RISE_MS,
    CW_DEFAULT_WORD_SPACE, CW_DEFAULT_WPM, CwSource, CwSyncFlags, holdoff_secs, hud_submode_str,
};
